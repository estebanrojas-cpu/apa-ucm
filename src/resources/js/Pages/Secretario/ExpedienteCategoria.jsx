...
export default function ExpedienteCategoria({ nomina, categoria, evidenciasNormales, evidenciasApelacion }) {
    return (
        <>
            ...
            <AppLayout title={categoria.nombre}>
                ...
                <div className="flex items-center gap-2 text-sm text-gray-500 -mt-4 mb-6">
                    <Link href="/secretario/expedientes" className="hover:text-[#1B2D6B] transition-colors">
                        Expedientes
                    </Link>
                    <span>/</span>
                    <Link href={`/secretario/expedientes/${nomina.id}`} className="hover:text-[#1B2D6B] transition-colors">
                        {nomina.nombre}
                    </Link>
                    <span>/</span>
                ...
                <section className="mb-8">
                    ...
                    <FileList evidencias={evidenciasNormales} emptyMsg="El académico no ha cargado archivos en esta categoría." />
                </section>
                ...
                {evidenciasApelacion.length > 0 && (
                    <section>
                        ...
                        <FileList evidencias={evidenciasApelacion} />
                    </section>
                )}
